...
1. Структуруйте код і використовуйте конвенції
...
3. Використовуйте каскад розумно
...
5. Уникайте дублювання Виносьте повторювані значення у змінні (у SCSS або CSS
   Custom Properties):
...
7. Мінімізуйте вплив на перерисовку Уникайте частих змін layout-властивостей
   (width, height, margin).

- Для анімацій використовуйте transform та opacity — вони не викликають reflow.

8. Готуйте до продакшну Мініфікуйте CSS (через cssnano, clean-css).

- Використовуйте critical CSS для швидкого відображення above-the-fold контенту.

- Вмикайте автопрефікси для кросбраузерності.

9. Тестуйте Перевіряйте сторінку в різних браузерах та на різних пристроях.
