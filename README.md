...
<details>
<summary>28. Різниця між блоковим та малим (інлайновим) елементами?</summary>

#### CSS

- **Блокові (block) та малі (інлайнові, inline) елементи** відрізняються способом відображення та впливом на структуру сторінки.
...
#### Малі (інлайнові) елементи (display: inline)
